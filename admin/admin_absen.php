...
<head>
    ...
    <title>Rekap Absensi (Admin) - SIPKL</title>
...
<body>
    ...
    <div class="app-container">
        ...
        <main class="main-content">
            ...
            <div class="card">
                <div class="card-title"><i data-lucide="calendar-check"></i> Data Kehadiran: <?= date('d M Y', strtotime($filter_tgl)) ?></div>
                ...
                <div class="table-responsive">
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr><td colspan="5" style="text-align:center; padding:20px; color:var(--text-muted);">Belum ada data absensi di tanggal ini.</td></tr>
                            ...
                            <tr>
                                ...
                                <td><span class="badge bg-border"><?= strtoupper($a['tipe_pkl']) ?></span></td>
                                <td>

...
if($conn) {
    $stmt = $conn->prepare("
        ...
        JOIN penempatan_dudi pd ON pd.id_siswa = a.id_siswa
        WHERE a.tanggal = ? AND pd.id_dudika = ? AND a.tipe_pkl = 'eksternal'
...
<head>
    ...
    <title>Pantau Kehadiran (DUDI) - SIPKL</title>
...
<body>
    ...
    <div class="app-container">
        ...
        <main class="main-content">
            ...
            <div class="card">
                <div class="card-title"><i data-lucide="calendar-check"></i> Rekap Kehadiran: <?= date('d M Y', strtotime($filter_tgl)) ?></div>
                <div class="table-responsive">
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr><td colspan="4" style="text-align:center; padding:20px; color:var(--text-muted);">Belum ada absen dari siswa bimbingan Anda.</td></tr>
                                ...
                                <td>
                                    ...
                                    <div class="info-cell">
                                        ...
                                        <div>
                                            ...
                                            <a href="https://www.google.com/maps/search/?api=1&query=<?= urlencode($a['latlong_datang']) ?>" target="_blank" class="map-link"><i data-lucide="map-pin" style="width:12px;"></i> Peta Lokasi</a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <?php else: echo "-"; endif; ?>
                                ...
                                <td>
                                    ...
                                    <div class="info-cell">
                                        ...
                                        <div>
                                            ...
                                            <a href="https://www.google.com/maps/search/?api=1&query=<?= urlencode($a['latlong_pulang']) ?>" target="_blank" class="map-link"><i data-lucide="map-pin" style="width:12px;"></i> Peta Lokasi</a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <?php else: echo "-"; endif; ?>
